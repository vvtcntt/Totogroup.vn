...
using TOTOGROUP.Models.Mapping;

namespace TOTOGROUP.Models
{
    public partial class TOTOGROUPContext : DbContext
    {
        static TOTOGROUPContext()
        {
            Database.SetInitializer<TOTOGROUPContext>(null);
        }

        public TOTOGROUPContext()
            : base("Name=TOTOGROUPContext")
        {
        }
        ...
        public DbSet<tblGroupPrice> tblGroupPrices { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new tblGroupPriceMap());
